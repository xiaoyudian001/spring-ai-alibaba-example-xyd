...
/**
 * Result returned by the deterministic learning workflow.
 */
public record LearningWorkflowResult(String content, LearningIntent intent, LearningMemory memoryBefore,
		LearningMemory memoryAfter, List<LearningWorkflowStep> workflowSteps, List<LearningGraphStep> graphSteps,
